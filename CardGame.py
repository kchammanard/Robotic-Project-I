...
class CardGame:
    def __init__()self,id,h,w,cx1,cx2:
    ...
    def count_players():
        ...
        while True:
            ...
            if len(lmList) != 0:
                ...
                cv2.putText(img, f"WAIT {int(time_count/10)}/5", (20, 100), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 2)
                if count != 1:
    ...
    #     serialcomm.write("shoot card")
    #     print(serialcomm.readline().decode('ascii'))
    #     serialcomm.write("next turn")
    #     print(serialcomm.readline().decode('ascii'))
...
while True:
    ...
    i = "Pending"
    if draw_card == 1 and turn_used == 0 and turn_used != 0:
        i = "shoot card"
        #time.sleep(0.2)
        turn_used = 1
        cards_left -= 1
